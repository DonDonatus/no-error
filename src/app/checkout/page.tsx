      ...
      <>
        ...
        <div className={styles.container}>
          <div className={styles.emptyCheckout}>
            ...
            <button onClick={() => router.push('/')} className={styles.shopNowButton}>
              Shop Now
            </button>
          </div>
        </div>
                  ...
                  <div className={styles.shippingOptions}>
                    <label className={styles.shippingOption}>
                      ...
                      <div className={styles.shippingOptionDetails}>
                        ...
                        <span className={styles.shippingPrice}>GHS 100</span>
                      </div>
                    </label>
                    ...
                    <label className={styles.shippingOption}>
                      ...
                      <div className={styles.shippingOptionDetails}>
                        ...
                        <span className={styles.shippingPrice}>GHS 150</span>
                      </div>
                    </label>
                    ...
                    {calculateSubtotal() >= 500 && (
                      <label className={styles.shippingOption}>
                        ...
                        <div className={styles.shippingOptionDetails}>
                          ...
                          <span className={styles.shippingPrice}>GHS 0</span>
                        </div>
                      </label>
                    )}
                  </div>
                ...
                return (
                  <div key={`${item.id}-${item.size}-${index}`} className={styles.orderItem}>
                    ...
                    <p className={styles.productPrice}>
                      GHS {(priceValue * item.quantity).toFixed(2)}
                    </p>
                  </div>
                );
              })}
            ...
            <div className={styles.summaryItems}>
              ...
              <div className={styles.totalRow}>
                ...
                <div className={styles.totalAmountWrapper}>
                  <span className={styles.currencyCode}>GHS</span>
